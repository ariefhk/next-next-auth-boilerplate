...
import RegisForm from "./register-form";
import DarkModeToggle from "@/components/common/dark-mode-button";
...
const RegisterPage = () => {
  return (
    <section className="container relative items-center justify-center md:grid lg:max-w-none lg:grid-cols-2 lg:px-0  h-screen flex">
      <DarkModeToggle className="absolute right-4 top-4 md:right-8 md:top-8" />
